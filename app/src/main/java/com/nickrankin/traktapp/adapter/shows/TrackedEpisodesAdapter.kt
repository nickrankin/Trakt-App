...
class TrackedEpisodesAdapter(private val sharedPreferences: SharedPreferences, private val glide: RequestManager, private val showPosterImageLoader: PosterImageLoader, private val callback: (trackedEpisode: TrackedEpisode) -> Unit): ListAdapter<TrackedEpisode, TrackedEpisodesAdapter.TrackedEpisodesViewHolder>(COMPARATOR) {
