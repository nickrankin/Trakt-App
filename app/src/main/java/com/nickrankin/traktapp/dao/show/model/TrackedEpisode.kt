...
data class TrackedEpisode(@PrimaryKey val trakt_id: Int, val tmdb_id: Int?, val show_trakt_id: Int, val show_tmdb_id: Int?, val airs_date: OffsetDateTime?, val networks: List<String?>, val title: String?, val show_title: String, val season: Int, val episode: Int, var lastRefreshed: OffsetDateTime, var dismiss_count: Int, val alreadyNotified: Boolean)