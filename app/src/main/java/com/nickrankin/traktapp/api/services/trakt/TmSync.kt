...
interface TmSync {
     ...
     * @param page   Number of page of results to be returned. If `null` but `limit` is provided defaults to
     * 1, otherwise items are paginated.
     * @param limit  Number of results to return per page. If `null` but `page` is provided defaults to 10,
